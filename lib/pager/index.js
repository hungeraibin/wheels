class Pager {
  ...
  _checkButtons() {
    if (this.currentPage === 1) {
      this.domRefs.first.setAttribute('disable', '')
      this.domRefs.prev.setAttribute('disable', '')
    } else {
      this.domRefs.first.removeAttribute('disable')
      this.domRefs.prev.removeAttribute('disable')
    }
